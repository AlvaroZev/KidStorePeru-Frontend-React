...
interface GiftSlotStatusCompactProps {
  accountId: string;
...
const GiftSlotStatusCompact: React.FC<GiftSlotStatusCompactProps> = ({
  accountId,
  onStatusUpdate,
}) => {
  ...
  return (
    <div className="gift-slot-compact text-xs">
      ...
      <div className="w-full bg-gray-700 rounded-full h-1 mt-1">
        <div
          className={`gift-slot-progress progress-bar h-1 rounded-full transition-all duration-300 ${
...
export default GiftSlotStatusCompact;
